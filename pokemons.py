...
Raichu = Pokemon('Raichu', 200, list(habilidades.keys())[0:4], 'Electrico', 180)
Sandslash = Pokemon('Sandslash', 240, list(habilidades.keys())[7:11], 'Tierra', 150)
Alakazam = Pokemon('Alakazam', 210, list(habilidades.keys())[8:12], 'Psiquico', 175)
...
Dragonite = Pokemon('Dragonite', 320, list(habilidades.keys())[9:13], 'Dragon', 100)
...
Jolteon = Pokemon('Jolteon', 210, list(habilidades.keys())[0:4], 'Electrico', 170)
...
Slowbro = Pokemon('Slowbro', 320, list(habilidades.keys())[16:23:2], 'Psiquico', 100)
Magneton = Pokemon('Magneton', 250, list(habilidades.keys())[0:4], 'Electrico', 140)
...
Hypno = Pokemon('Hypno', 270, list(habilidades.keys())[8:12], 'Psiquico', 130)
Kingler = Pokemon('Kingler', 260, list(habilidades.keys())[3:7], 'Agua', 140)
Electrode = Pokemon('Electrode', 200, list(habilidades.keys())[0:4], 'Electrico', 190) 
